class RankingUtils {
  ...
  rankPublications(publications, query, disease, boostFactors = {}) {
    ...
    // Sort by rank score descending and return top 8
  ...
  mergeResults(publications, trials, query) {
    return {
      ...
      summary: `Found ${publications.length} research papers and ${trials.length} clinical trials. Top results ranked by relevance, recency, and authority.`
    };
  }
}
